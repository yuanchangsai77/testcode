...
| [TUI 设计规范](docs/tui-design-spec.md) | 终端交互、输入编辑、重绘和兼容性边界 | runtime orchestration |
| [TUI 架构路线图](docs/tui-architecture-roadmap.md) | 状态驱动 TUI 的目标架构、迁移顺序和验收标准 | 当前实现细节和产品优先级 |
